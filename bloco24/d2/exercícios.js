...
db.movies.updateMany( { title: { $in: ["Home Alone", "Batman"] } }, { $push: { category: "90's" } } );
...
db.movies.updateOne( { title: "Batman" }, { $push: { "cast.$[elemento].actor": "Christian Bale" } }, { arrayFilters: [ { "elemento.character": "Batman" } ] } );
// Adicione o campo actor , que deve ser um array com o valor Michael Caine , ao array de cast em que o campo character seja igual a Alfred ;
db.movies.updateOne( { title: "Batman" }, { $push: { "cast.$[elemento].actor": "Michael Caine" } }, { arrayFilters: [ { "elemento.character": "Alfred" } ] } );
// Adicione o campo actor , que deve ser um array com o valor Heath Ledger , ao array de cast em que o campo character seja igual a Coringa .
db.movies.updateOne( { title: "Batman" }, { $push: { "cast.$[elemento].actor": "Heath Ledger" } }, { arrayFilters: [ { "elemento.character": "Coringa" } ] } );

// Exercício 12: Adicione aos atores de cast do character Batman do filme Batman os valores "Michael Keaton" , "Val Kilmer" e "George Clooney" , e deixe o array em ordem alfabética.
db.movies.updateOne( { title: "Batman" }, { $push: { "cast.$[elemento].actor": { $each: ["Michael Keaton", "Val Kilmer", "George Clooney"], $sort: 1 } } }, { arrayFilters: [ { "elemento.character": "Batman" } ] } );
